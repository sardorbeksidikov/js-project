const City = ["Qarshi", "Samarqand", "Toshkent", "Farg'ona"];
...
const pupilTable = document.getElementById("pupilelisTable");
const pupilForm = document.getElementById("personForm");
...
const positionPupil = document.getElementById("positionPupile");
